        ...
        <SafeAreaView className="flex-1" style={{ backgroundColor: "#192031" }}>
            ...
            <View className="h-full">
                <View className="w-full px-4 items-center my-8">
                    ...
                    <Animated.View entering={FadeInDown.duration(200).delay(400).springify()} className="mt-4">
                    ...
                    <Animated.View entering={FadeInDown.duration(200).delay(600).springify()} className="h-1/4 w-full justify-start pt-8 px-4">
                        <Pressable
                        onPress={()=>router.push("/(tabs)")}
                         className="bg-[#12B3AB] rounded-xl justify-center items-center py-4">
